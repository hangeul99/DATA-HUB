...
| OpenStreetMap Foundation | 주소 검색 및 지도 시각화 서비스 (데이터 분석 기능 내 지도 기능에 한함) |

※ 위탁 계약 시 개인정보가 안전하게 관리될 수 있도록 관련 법령에 따른 조항을 규정하고 있습니다.`,
  },
  {
    title: "제5조의2 (개인정보의 국외 이전)",
    content: `센터는 아래와 같이 개인정보를 국외로 이전하고 있습니다. 개인정보보호법 제28조의8에 따라 이를 고지합니다.

| 이전받는 자 | 국가 | 이전 목적 | 이전 항목 | 보유·이용 기간 |
|------------|------|-----------|-----------|---------------|
| Supabase Inc. | 미국 | 데이터베이스 저장 및 인증 | 회원 정보 전항목, 이용 기록 | 회원 탈퇴 시까지 |
| Vercel Inc. | 미국 | 웹 서비스 호스팅 | 접속 로그 | 1년 |
| OpenStreetMap Foundation | 영국 | 주소 좌표 변환 | 입력 주소 텍스트 | 요청 즉시 파기 |

※ 정보주체는 국외 이전에 동의하지 않을 권리가 있으며, 미동의 시 데이터 분석 기능의 지도 시각화 서비스 이용이 제한될 수 있습니다.`,
  },
  {
...
정보주체는 센터의 서비스를 이용하시면서 발생한 모든 개인정보 보호 관련 문의, 불만 처리, 피해 구제 등에 관한 사항을 개인정보 보호책임자에게 문의하실 수 있습니다.`,
  },
  {
    ...
    content: `이 개인정보처리방침은 2026년 7월 1일부터 적용됩니다. 내용 추가, 삭제 및 수정이 있을 경우에는 변경사항의 시행 7일 전부터 공지사항을 통하여 고지할 것입니다.

▶ 개정 이력
| 버전 | 시행일 | 주요 변경 사항 |
|------|--------|--------------|
| v1.1 | 2026.07.01 | 국외 이전 조항(제5조의2) 신설, OpenStreetMap 제3자 위탁 추가, 보호책임자 정보 보완 |
| v1.0 | 2026.01.01 | 최초 제정 |`,
  },
];
      ...
      <main className="min-h-screen bg-neutral-50 pt-20">
        ...
        <div className="bg-white border-b border-neutral-200">
          <div className="max-w-4xl mx-auto px-6 py-12">
            ...
            <p className="text-xs text-neutral-400 mt-3">시행일: 2026년 7월 1일 (v1.1)</p>
          </div>
        </div>
