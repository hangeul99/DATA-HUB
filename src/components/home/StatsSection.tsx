...
export default function StatsSection() {
  ...
  const [stats, setStats]       = useState<StatItem[]>([
    { value: 0, suffix: "+", label: "?±ë¡ ?°ì´?°ì…‹" },
    { value: 0, suffix: "+", label: "ì´?? ì²­ ê±´ìˆ˜" },
    { value: 0, suffix: "+", label: "ì´??¤ìš´ë¡œë“œ" },
    { value: 4, suffix: "ê°?, label: "?°ì´??ì¹´í…Œê³ ë¦¬" },
  ]);

  // Supabase?ì„œ ?¤ì‹œê°??˜ì¹˜ ì¡°íšŒ
  useEffect(() => {
    ...
    (async () => {
      ...
      setStats([
        { value: datasets  ?? 0, suffix: "+", label: "?±ë¡ ?°ì´?°ì…‹" },
        { value: applications ?? 0, suffix: "+", label: "ì´?? ì²­ ê±´ìˆ˜" },
        { value: downloads ?? 0, suffix: "+", label: "ì´??¤ìš´ë¡œë“œ" },
        { value: 4, suffix: "ê°?, label: "?°ì´??ì¹´í…Œê³ ë¦¬" },
      ]);
    })();
  }, []);
